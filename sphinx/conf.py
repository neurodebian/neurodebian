...
#extensions = []
sys.path.append(os.path.abspath('.'))
sys.path.append(os.path.abspath(os.path.join('..', '..' , '3rd', 'sphinx-bootstrap-theme')))
...
copyright = u'2009-2015, NeuroDebian Team <team@neuro.debian.net>'
