...
$(shell . '$(ndtool_rootdir)/helpers/distinfo-file-helper' && distinfo_get_build_container_image_vendor '$(1)-$(2)')
endef

# Find distribution of base image used for build container images

define find_build_base_image_distribution
$(shell . '$(ndtool_rootdir)/helpers/distinfo-file-helper' && distinfo_get_build_container_image_distribution '$(1)-$(2)')
endef
...
.base-%:
	...
	*) \
	...
	'$(PODMAN)' build \
		...
		-f '$(ndtool_rootdir)/containerfiles/Containerfile.dummy' \
...
.arch-test: .base-debian-sid-$(NATIVE_ARCH)
	...
	'$(PODMAN)' build \
		...
		-f '$(ndtool_rootdir)/containerfiles/arch-test/Containerfile' \
...
.lintian: .base-debian-sid-$(NATIVE_ARCH)
	...
	'$(PODMAN)' build \
		...
		-f '$(ndtool_rootdir)/containerfiles/lintian/Containerfile' \
		--build-arg "ARCH=$${NATIVE_ARCH}" \
		--layer-label 'ndVendor=tooling' \
		--layer-label 'ndPruneOnSuccess=true' \
		--layer-label 'ndPruneOnFailure=true' \
...
.builder-%:
	...
	'$(PODMAN)' build \
		...
		-f "$(ndtool_rootdir)/containerfiles/builder/Containerfile.$${BASE_VENDOR}" \
