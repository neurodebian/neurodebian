...
\item[``Always-ready-to-release'']\hfill\emph{Testing} (now \emph{stretch})\\
...
\item[Official release]\hfill\emph{Stable} (now 8.1, \emph{jessie})\\
...
\item[Community knowledge exchange portal]
  \url{http://neurostars.org/t/neurodebian}
%{http://community.neurodebian.org}
...
developing the Debian operating system, to the
\href{http://www.incf.org}{INCF} for support in community outreach
and technical collaborations, to the Center of Behavioral Brain Sciences
Magdeburg for support, and to
Prof. \href{http://haxbylab.dartmouth.edu}{James V. Haxby}
(\href{http://www.dartmouth.edu/~psych}{PBS Department, Dartmouth
  College}) for his continued patronage and endless supply of Italian
